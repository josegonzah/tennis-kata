...
public class TennisGame3 implements TennisGame {
    ...
    public String getScore() {
        if (player1Score < 4 && player2Score < 4 && (player1Score + player2Score != 6)) {
            return getScoresNotTied();
        }
        return getScoreAfter45();
    }

    private String getScoreAfter45() {
        if (player1Score == player2Score)
            return "Deuce";
        return getScoresAdvantage();
    }

    private String getScoresAdvantage() {
    ...
    private String getScoresNotTied() {
        String s;
